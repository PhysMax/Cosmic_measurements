...
{ 
  ...
  G4double scinLength = 40*cm;
  G4double scinHeight = 2*cm;
  G4double scinWidth = 10*cm; 
  G4double dist = 10*cm;
  ...
  G4LogicalVolume* sc2lv = new G4LogicalVolume(sc1box, water, "sc2lv");
  ...
  new G4PVPlacement(rot, G4ThreeVector(0.,sin(angle),cos(angle))*dist/2,
